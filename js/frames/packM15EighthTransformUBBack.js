...
availableFrames = [
	{name:'White Frame', src:'/img/frames/custom/m15-eighth/transform/back/ub/w.png', masks:masks},
	{name:'Blue Frame', src:'/img/frames/custom/m15-eighth/transform/back/ub/u.png', masks:masks},
	{name:'Black Frame', src:'/img/frames/custom/m15-eighth/transform/back/ub/b.png', masks:masks},
	{name:'Red Frame', src:'/img/frames/custom/m15-eighth/transform/back/ub/r.png', masks:masks},
	{name:'Green Frame', src:'/img/frames/custom/m15-eighth/transform/back/ub/g.png', masks:masks},
	{name:'Multicolored Frame', src:'/img/frames/custom/m15-eighth/transform/back/ub/m.png', masks:masks},
	{name:'Artifact Frame', src:'/img/frames/custom/m15-eighth/transform/back/ub/a.png', masks:masks},
	{name:'Vehicle Frame', src:'/img/frames/custom/m15-eighth/transform/back/ub/v.png', masks:masks},
	{name:'Land Frame', src:'/img/frames/custom/m15-eighth/transform/back/ub/l.png', masks:masks},
	...
	{name:'Red Power/Toughness', src:'/img/frames/m15/transform/ub/ptR.png', bounds:bounds},
	...
	{name:'White Land Frame', src:'/img/frames/custom/m15-eighth/transform/back/ub/wl.png', masks:masks},
	{name:'Blue Land Frame', src:'/img/frames/custom/m15-eighth/transform/back/ub/ul.png', masks:masks},
	{name:'Black Land Frame', src:'/img/frames/custom/m15-eighth/transform/back/ub/bl.png', masks:masks},
	{name:'Red Land Frame', src:'/img/frames/custom/m15-eighth/transform/back/ub/rl.png', masks:masks},
	{name:'Green Land Frame', src:'/img/frames/custom/m15-eighth/transform/back/ub/gl.png', masks:masks},
	{name:'Multicolored Land Frame', src:'/img/frames/custom/m15-eighth/transform/back/ub/ml.png', masks:masks},
...
document.querySelector('#loadFrameVersion').onclick = async function() {
	...
	//sets card version
	card.version = 'm15EighthTransformUBBack';
	//art bounds
	...
	loadBottomInfo({
		...
		wizards: {name:'wizards', text:'{conditionalcolor:M15_Border,Vehicle_Frame:white}\u2122 & \u00a9 1993-{elemidinfo-year} Wizards of the Coast, Inc. {elemidinfo-number}', x:0.0647, y:1958/2100, width:0.8107, height:0.0153, oneLine:true, font:'mplantin', size:0.0153, color:'black', shadowX:0.0007, shadowY:0.0005},
	});
}
