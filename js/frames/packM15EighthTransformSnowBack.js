...
availableFrames = [
	{name:'White Frame', src:'/img/frames/custom/m15-eighth/transform/back/snow/w.png', masks:masks},
	{name:'Blue Frame', src:'/img/frames/custom/m15-eighth/transform/back/snow/u.png', masks:masks},
	{name:'Black Frame', src:'/img/frames/custom/m15-eighth/transform/back/snow/b.png', masks:masks},
	{name:'Red Frame', src:'/img/frames/custom/m15-eighth/transform/back/snow/r.png', masks:masks},
	{name:'Green Frame', src:'/img/frames/custom/m15-eighth/transform/back/snow/g.png', masks:masks},
	{name:'Multicolored Frame', src:'/img/frames/custom/m15-eighth/transform/back/snow/m.png', masks:masks},
	{name:'Artifact Frame', src:'/img/frames/custom/m15-eighth/transform/back/snow/a.png', masks:masks},
	{name:'Land Frame', src:'/img/frames/custom/m15-eighth/transform/back/snow/l.png', masks:masks},
	...
	{name:'White Land Frame', src:'/img/frames/custom/m15-eighth/transform/back/snow/wl.png', masks:masks},
	{name:'Blue Land Frame', src:'/img/frames/custom/m15-eighth/transform/back/snow/ul.png', masks:masks},
	{name:'Black Land Frame', src:'/img/frames/custom/m15-eighth/transform/back/snow/bl.png', masks:masks},
	{name:'Red Land Frame', src:'/img/frames/custom/m15-eighth/transform/back/snow/rl.png', masks:masks},
	{name:'Green Land Frame', src:'/img/frames/custom/m15-eighth/transform/back/snow/gl.png', masks:masks},
	{name:'Multicolored Land Frame', src:'/img/frames/custom/m15-eighth/transform/back/snow/ml.png', masks:masks},
...
document.querySelector('#loadFrameVersion').onclick = async function() {
	...
	//sets card version
	card.version = 'm15EighthTransformSnowBack';
	//art bounds
