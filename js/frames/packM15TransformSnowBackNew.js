...
var masks = [{src:'/img/frames/m15/transform/regular/new/maskPinlineBack.png', name:'Pinline'}, {src:'/img/frames/m15/transform/regular/new/maskTitle.png', name:'Title'}, {src:'/img/frames/m15/regular/m15MaskType.png', name:'Type'}, {src:'/img/frames/m15/regular/m15MaskRules.png', name:'Rules'}, {src:'/img/frames/m15/transform/regular/new/maskFrameBack.png', name:'Frame'}, {src:'/img/frames/m15/regular/m15MaskBorder.png', name:'Border'}];
var bounds = {x:0.7573, y:0.8848, width:0.188, height:0.0733};
//defines available frames
availableFrames = [
	{name:'White Frame', src:'/img/frames/m15/transform/snow/new/backW.png', masks:masks},
	{name:'Blue Frame', src:'/img/frames/m15/transform/snow/new/backU.png', masks:masks},
	{name:'Black Frame', src:'/img/frames/m15/transform/snow/new/backB.png', masks:masks},
	{name:'Red Frame', src:'/img/frames/m15/transform/snow/new/backR.png', masks:masks},
	{name:'Green Frame', src:'/img/frames/m15/transform/snow/new/backG.png', masks:masks},
	{name:'Multicolored Frame', src:'/img/frames/m15/transform/snow/new/backM.png', masks:masks},
	{name:'Artifact Frame', src:'/img/frames/m15/transform/snow/new/backA.png', masks:masks},
	{name:'Land Frame', src:'/img/frames/m15/transform/snow/new/backL.png', masks:masks},
...
document.querySelector('#loadFrameVersion').onclick = async function() {
	...
	//sets card version
	card.version = 'm15TransformSnowBackNew';
	//art bounds
