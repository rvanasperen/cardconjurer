...
availableFrames = [
	{name:'White Frame', src:'/img/frames/m15/transform/ub/backW.png', masks:masks},
	{name:'Blue Frame', src:'/img/frames/m15/transform/ub/backU.png', masks:masks},
	{name:'Black Frame', src:'/img/frames/m15/transform/ub/backB.png', masks:masks},
	{name:'Red Frame', src:'/img/frames/m15/transform/ub/backR.png', masks:masks},
	{name:'Green Frame', src:'/img/frames/m15/transform/ub/backG.png', masks:masks},
	{name:'Multicolored Frame', src:'/img/frames/m15/transform/ub/backM.png', masks:masks},
...
document.querySelector('#loadFrameVersion').onclick = async function() {
	...
	//sets card version
	card.version = 'm15TransformUBBack';
	//art bounds
