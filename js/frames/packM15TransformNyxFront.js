...
availableFrames = [
	{name:'White Frame', src:'/img/frames/m15/transform/nyx/frontW.png', masks:masks},
	{name:'Blue Frame', src:'/img/frames/m15/transform/nyx/frontU.png', masks:masks},
	{name:'Black Frame', src:'/img/frames/m15/transform/nyx/frontB.png', masks:masks},
	{name:'Red Frame', src:'/img/frames/m15/transform/nyx/frontR.png', masks:masks},
	{name:'Green Frame', src:'/img/frames/m15/transform/nyx/frontG.png', masks:masks},
	{name:'Multicolored Frame', src:'/img/frames/m15/transform/nyx/frontM.png', masks:masks},
	{name:'Artifact Frame', src:'/img/frames/m15/transform/nyx/frontA.png', masks:masks},
...
document.querySelector('#loadFrameVersion').onclick = async function() {
	...
	//sets card version
	card.version = 'm15TransformNyxFront';
	//art bounds
