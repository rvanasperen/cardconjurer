...
availableFrames = [
	{name:'White Frame', src:'/img/frames/m15/transform/snow/backW.png', masks:masks},
	{name:'Blue Frame', src:'/img/frames/m15/transform/snow/backU.png', masks:masks},
	{name:'Black Frame', src:'/img/frames/m15/transform/snow/backB.png', masks:masks},
	{name:'Red Frame', src:'/img/frames/m15/transform/snow/backR.png', masks:masks},
	{name:'Green Frame', src:'/img/frames/m15/transform/snow/backG.png', masks:masks},
	{name:'Multicolored Frame', src:'/img/frames/m15/transform/snow/backM.png', masks:masks},
	{name:'Artifact Frame', src:'/img/frames/m15/transform/snow/backA.png', masks:masks},
	{name:'Land Frame', src:'/img/frames/m15/transform/snow/backL.png', masks:masks},
...
document.querySelector('#loadFrameVersion').onclick = async function() {
	...
	//sets card version
	card.version = 'm15TransformSnowBack';
	//art bounds
