...
availableFrames = [
	{name:'White Frame', src:'/img/frames/m15/transform/nyx/backW.png', masks:masks},
	{name:'Blue Frame', src:'/img/frames/m15/transform/nyx/backU.png', masks:masks},
	{name:'Black Frame', src:'/img/frames/m15/transform/nyx/backB.png', masks:masks},
	{name:'Red Frame', src:'/img/frames/m15/transform/nyx/backR.png', masks:masks},
	{name:'Green Frame', src:'/img/frames/m15/transform/nyx/backG.png', masks:masks},
	{name:'Multicolored Frame', src:'/img/frames/m15/transform/nyx/backM.png', masks:masks},
	{name:'Artifact Frame', src:'/img/frames/m15/transform/nyx/backA.png', masks:masks},
...
document.querySelector('#loadFrameVersion').onclick = async function() {
	...
	//sets card version
	card.version = 'm15TransformNyxBack';
	//art bounds
