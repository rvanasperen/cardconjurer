...
availableFrames = [
	{name:'White Frame', src:'/img/frames/custom/m15-eighth/transform/front/ub/w.png', masks:masks},
	{name:'Blue Frame', src:'/img/frames/custom/m15-eighth/transform/front/ub/u.png', masks:masks},
	{name:'Black Frame', src:'/img/frames/custom/m15-eighth/transform/front/ub/b.png', masks:masks},
	{name:'Red Frame', src:'/img/frames/custom/m15-eighth/transform/front/ub/r.png', masks:masks},
	{name:'Green Frame', src:'/img/frames/custom/m15-eighth/transform/front/ub/g.png', masks:masks},
	{name:'Multicolored Frame', src:'/img/frames/custom/m15-eighth/transform/front/ub/m.png', masks:masks},
	{name:'Artifact Frame', src:'/img/frames/custom/m15-eighth/transform/front/ub/a.png', masks:masks},
	{name:'Vehicle Frame', src:'/img/frames/custom/m15-eighth/transform/front/ub/v.png', masks:masks},
	{name:'Land Frame', src:'/img/frames/custom/m15-eighth/transform/front/ub/l.png', masks:masks},
	...
	{name:'White Land Frame', src:'/img/frames/custom/m15-eighth/transform/front/ub/wl.png', masks:masks},
	{name:'Blue Land Frame', src:'/img/frames/custom/m15-eighth/transform/front/ub/ul.png', masks:masks},
	{name:'Black Land Frame', src:'/img/frames/custom/m15-eighth/transform/front/ub/bl.png', masks:masks},
	{name:'Red Land Frame', src:'/img/frames/custom/m15-eighth/transform/front/ub/rl.png', masks:masks},
	{name:'Green Land Frame', src:'/img/frames/custom/m15-eighth/transform/front/ub/gl.png', masks:masks},
	{name:'Multicolored Land Frame', src:'/img/frames/custom/m15-eighth/transform/front/ub/ml.png', masks:masks},
...
document.querySelector('#loadFrameVersion').onclick = async function() {
	...
	//sets card version
	card.version = 'm15EighthTransformUBFront';
	//art bounds
