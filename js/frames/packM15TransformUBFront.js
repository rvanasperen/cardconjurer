...
availableFrames = [
	{name:'White Frame', src:'/img/frames/m15/transform/ub/frontW.png', masks:masks},
	{name:'Blue Frame', src:'/img/frames/m15/transform/ub/frontU.png', masks:masks},
	{name:'Black Frame', src:'/img/frames/m15/transform/ub/frontB.png', masks:masks},
	{name:'Red Frame', src:'/img/frames/m15/transform/ub/frontR.png', masks:masks},
	{name:'Green Frame', src:'/img/frames/m15/transform/ub/frontG.png', masks:masks},
	{name:'Multicolored Frame', src:'/img/frames/m15/transform/ub/frontM.png', masks:masks},
...
document.querySelector('#loadFrameVersion').onclick = async function() {
	...
	//sets card version
	card.version = 'm15TransformUBFront';
	//art bounds
