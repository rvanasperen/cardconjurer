...
availableFrames = [
	{name:'White Frame', src:'/img/frames/m15/transform/nyx/new/backW.png', masks:masks},
	{name:'Blue Frame', src:'/img/frames/m15/transform/nyx/new/backU.png', masks:masks},
	{name:'Black Frame', src:'/img/frames/m15/transform/nyx/new/backB.png', masks:masks},
	{name:'Red Frame', src:'/img/frames/m15/transform/nyx/new/backR.png', masks:masks},
...
document.querySelector('#loadFrameVersion').onclick = async function() {
	...
	//sets card version
	card.version = 'm15TransformNyxBackNew';
	//art bounds
