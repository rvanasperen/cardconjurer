...
availableFrames = [
	{name:'White Frame', src:'/img/frames/m15/transform/ub/new/backW.png', masks:masks},
	{name:'Blue Frame', src:'/img/frames/m15/transform/ub/new/backU.png', masks:masks},
	{name:'Black Frame', src:'/img/frames/m15/transform/ub/new/backB.png', masks:masks},
	{name:'Red Frame', src:'/img/frames/m15/transform/ub/new/backR.png', masks:masks},
	{name:'Green Frame', src:'/img/frames/m15/transform/ub/new/backG.png', masks:masks},
	{name:'Multicolored Frame', src:'/img/frames/m15/transform/ub/new/backM.png', masks:masks},
...
document.querySelector('#loadFrameVersion').onclick = async function() {
	...
	//sets card version
	card.version = 'm15TransformUBBackNew';
	//art bounds
